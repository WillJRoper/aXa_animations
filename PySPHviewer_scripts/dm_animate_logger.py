...
import os
from utilities import parse_arguments, data_from_logger
...
def single_frame(args, time, num, nframes, res):
    ...
    fig.savefig('../plots/Ani/DM/DM_Cube_' + time + 'L0025N0500.png',
                bbox_inches='tight',
                pad_inches=0)
...
single_frame(args, time=0.1, num=100, nframes=1000, res=res)
